...
/**
 * Servlet implementation class ListarPsicologoServlet
 */
@WebServlet("/listarPsicologoServlet")
public class ListarPsicologoServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public ListarPsicologoServlet() {
        super();
