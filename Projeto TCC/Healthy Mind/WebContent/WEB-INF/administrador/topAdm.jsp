...
<nav class="navbar navbar-default navbar-static-top">
	<div class="container-fluid">
		...
		<div class="navbar-header">
			...
			<a class="navbar-brand" href="menuAdministradorServlet">Mente Saudável <span
			...
			<ul class="nav navbar-nav">
				...
				<li class="dropdown"><a href="#" class="dropdown-toggle"
					...
					<ul class="dropdown-menu">
						<li><a href="cadastrarAdministradorServlet"><span class="glyphicon glyphicon-plus-sign"></span> Cadastrar Administrador</a></li>
						<li><a href="listarAdministradorServlet"><span class="glyphicon glyphicon-list-alt"></span> Lista de Administradores</a></li>
				</ul></li>
				...
				<li class="dropdown"><a href="#" class="dropdown-toggle"
					...
					<ul class="dropdown-menu">
						<li><a href="cadastrarConvenioServlet"><span class="glyphicon glyphicon-plus-sign"></span> Cadastrar Convênio</a></li>
						<li><a href="listarConvenioServlet"><span class="glyphicon glyphicon-list-alt"></span> Lista de Convênios</a></li>
				</ul></li>
